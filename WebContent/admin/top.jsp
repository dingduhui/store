...
TH {
	...
	<body>
		<table width="100%" height="70%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td >
					<img width="350px" height="100px" src="${pageContext.request.contextPath}/img/admin/htLogo.png" align="middle" >
				</td>

				<td width="100%" background="${pageContext.request.contextPath}/img/admin/logo2.jpg">
				</td>
			</tr>
		</table>
